<div class="container col-6">
    ...
    <form method="post" action="">
        ...
        <div class="form-group">
            <label for="goodresponse">Bonne réponse:</label>
            <input type="text" class="form-control" id="goodresponse" name="response" placeholder="Bonne réponse">
        </div>

        <!-- Input ou la prof inscrit les mauvaises réponses -->
        <!-- <div class="form-group">
            <label for="badresponses">Mauvaises réponses:</label>
            <input type="text" class="form-control mb-3" id="badresponses" placeholder="Mauvaise réponse 1">
